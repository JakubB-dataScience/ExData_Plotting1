...
with(consumption, {
  plot(Global_active_power~dateTime2, type="l", ylab="Global Active Power (kilowatts)", xlab="")
  plot(Voltage~dateTime2, type="l", ylab="Voltage (volt)", xlab="")
  ...
  plot(Global_reactive_power~dateTime2, type="l", ylab="Global Rective Power (kilowatts)",xlab="")
})

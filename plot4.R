...
with(consumption, {
  plot(Global_active_power~dateTime2, type="l", ylab="Global Active Power", xlab="")
  plot(Voltage~dateTime2, type="l", ylab="Voltage", xlab="")
  ...
  plot(Global_reactive_power~dateTime2, type="l", ylab="Global Reactive Power",xlab="")
})
